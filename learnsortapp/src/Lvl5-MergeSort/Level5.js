           ...
           <h1 class = "sort-title1">MergeSort</h1>
            ...
            <div class = "Outline2">
                <div class = "BackgroundRectangle2">
                    <h2>Level 5</h2>
                    <p>Now that you have completed Level 4 of merge sort, you can proceed to Level 5!</p>
                    <p>As done in Level , you'll be given an unsorted list but no description of the steps in the merge sort algorithm.</p>
               ...
               <Link to='/MergeSortComponent4' class = "continue-link1">
